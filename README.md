...
- ### Stack
    - [x] [Stacks (video)](https://www.coursera.org/lecture/data-structures/stacks-UdKzQ)
       - [Memo] Stacks can be implemented with Array or Linked Lists, LIFO
    - [ ] [[Review] Stacks in 3 minutes (video)](https://youtu.be/KcT3aVgrrpU)
    - [ ] Will not implement. Implementing with array is trivial

- ### Queue
    - [x] [Queue (video)](https://www.coursera.org/lecture/data-structures/queues-EShpq)
       - [Memo] Queue can be implemented with Array or Linked Lists, FIFO
    ...
    - [ ] [Practice] on VScode
       - [x] Queue implementation with Array
...
- ### Hash table
    - [ ] Videos:
        ...
        - [x] [Table Doubling, Karp-Rabin (video)](https://www.youtube.com/watch?v=BRO7mVIFt08&index=9&list=PLUl4u3cNGP61Oq3tWYp6V_F-5jb5L2iHb)
           ...
           - [Yarinokoshi] Cost of insert n is Θ(n) in Table Doubling (15:00)
...
- ### Binary search
    - [x] [Binary Search (video)](https://www.youtube.com/watch?v=D5SrAga1pno)
       - [Memo] Case not better than linear search is avoided by more complex data structure, but not randomly shuffled input values is.
    - [pass] [Binary Search (video)](https://www.khanacademy.org/computing/computer-science/algorithms/binary-search/a/binary-search)
...
- ### Bitwise operations
    ...
    - [ ] Get a really good understanding of manipulating bits with: &, |, ^, ~, >>, <<
        ...
        - [x] Good intro:
	        ...
	        - [Memo] Modify Bit is technical(28:25~): in order to set state(0 or 1) on the target bit, ((- state) | bit set) is the solution.
	        - [Yarinokoshi] Solution to the exercise at end of the video (bit count): http://www.mwsoft.jp/programming/java/java_lang_integer_bit_count.html
...
- ### Trees - Intro
    ...
    - [x] [Tree Traversal (video)](https://www.coursera.org/lecture/data-structures/tree-traversal-fr51b)
       - [Memo] Depth-First Search: InOrderTraversal, PreOrderTraversal, PostOrderTraversal; Breadth-First Search: LevelTraversal 
...
- ### Binary search trees: BSTs
    ...
    - [x] [MIT (video)](https://www.youtube.com/watch?v=76dhtgZt38A&ab_channel=MITOpenCourseWare)
       - [Memo] Binary Tree: O(h); Traversal Order (InOrderTraversal); Traveral Operations (subtree_first(node), successor(node), subtree_insert_after(node, new), subtree_delete(node)); How to implement Sequence & Set (47:00~)
    - C/C++:
...
- ### Heap / Priority Queue / Binary Heap
    ...
    - [Memo] Heap is used as a word of data structure here.
    - [ ] [Heap](https://en.wikipedia.org/wiki/Heap_(data_structure))
    - [x] [Introduction (video)](https://www.coursera.org/lecture/data-structures/introduction-2OpTs)
       - [Memo] Algorithms using Priority Queue: Dijsktra, Prim, Huffman, Heap Sort
    ...
    - [Video I Added] https://www.youtube.com/watch?v=2DmK_H7IdTo
       - [Memo] No need to watch.
    - [x] [MIT: Heaps and Heap Sort (video)](https://www.youtube.com/watch?v=B7hVxCmfPtM&index=4&list=PLUl4u3cNGP61Oq3tWYp6V_F-5jb5L2iHb)
       - [Memo] The assumption of max-heapify "the trees rooted at left and right are max heaps" is the key for O(nlog n).
       - [Difficult] The reason that careful assumption get to O(n).(39:00~)
    - [x] [CS 61B Lecture 24: Priority Queues (video)](https://archive.org/details/ucberkeley_webcast_yIUFT6AKBGE)
       - [Memo] Pritority Queues is ADT, and Binary Heap is an implementation of it.
       - [Memo] Order is Level Ordering.
       - [Memo] Commonly used as "Event Queues".
       - [Memo] Compare running time with (Un)sorted List.
...
- [ ] [Sedgewick - Mergesort (5 videos)](https://www.coursera.org/learn/algorithms-part1/home/week/3)
    - [x] [1. Mergesort](https://www.coursera.org/lecture/algorithms-part1/mergesort-ARWDq)
       - [Memo] Merge sort is the processes that merge sorted two subarrays to sorted one array.
       - [Memo] Complexity of Merge Sort and arithmetic proof of it.
       - [Memo] How to improve Merge sort
    ...
    - [x] [3. Sorting Complexity](https://www.coursera.org/lecture/algorithms-part1/sorting-complexity-xAltF)
       - [Memo] Computational Complexity: computation model, cost model, upper bounds, lower bounds, optimal model
       - [Memo] Example of Complexity in Sort: decision tree, #compares, nlgn from merge sort, nlgn, merge sort
       - [Memo] Merge Sort is optimal with respect to #compares, not with memory.
       - [Yarinokoshi] What is "lower bound and upper bound".
    ...
    - [x] [5. Stability](https://www.coursera.org/learn/algorithms-part1/lecture/pvvLZ/stability)
       - [Memo] Stable: Insertion, Merge; Not Stable: Selection, Shell

- [ ] [Sedgewick - Quicksort (4 videos)](https://www.coursera.org/learn/algorithms-part1/home/week/3)
    - [x] [1. Quicksort](https://www.coursera.org/lecture/algorithms-part1/quicksort-vjvnC)
       - [Memo] Arithmetic proof of #compares (nlgn). Worst: Quadratic
       - [Memo] Shuffle is the key to avoid worst case.
       - [Memo] Not stable
    ...
    - [x] [3. Duplicate Keys](https://www.coursera.org/lecture/algorithms-part1/duplicate-keys-XvjPd)
       - [Memo] Dijkstra 3-way Quick Sort
...
- [ ] UC Berkeley:
    ...
    - [x] [CS 61B 2014-04-21: Radix Sort(video)](https://archive.org/details/ucberkeley_webcast_pvbBMd-3NoI)
       - [Memo] Nearly completely similar to video above.
...
- [x] [Insertion Sort, Merge Sort (video)](https://www.youtube.com/watch?v=Kg4bqzAqRBM&index=3&list=PLUl4u3cNGP61Oq3tWYp6V_F-5jb5L2iHb)
   - [Memo] Complexity of Insertion sort & Merge sort, Improvement of Insertion sort with binary search.
...
- [ ] Not required, but I recommended them:
    - [ ] [Sedgewick - Radix Sorts (6 videos)](https://www.coursera.org/learn/algorithms-part2/home/week/3)
        ...
        - [x] [4. Most Significant Digit First String Radix Sort](https://www.coursera.org/learn/algorithms-part2/lecture/gFxwG/msd-radix-sort)
           - [Memo] Java Code: https://www.informit.com/articles/article.aspx?p=2180073&seqNum=3 
        ...
        - [x] [6. Suffix Arrays](https://www.coursera.org/learn/algorithms-part2/lecture/TH18W/suffix-arrays)
           - [Memo] Suffix Sort is used to Search for query or Longest Repeated Substring
           - [Memo] To search very long Longest Repeated Substring, use specialized algo (Manber-Mayers algo: worst in NlgN; use inverse array)
...
- [ ] Skiena Lectures - great intro:
    - [x] [CSE373 2020 - Lecture 10 - Graph Data Structures (video)](https://www.youtube.com/watch?v=Sjk0xqWWPCc&list=PLOtl7M3yp-DX6ic0HGT0PUX_wiNmkWkXx&index=10)
       - [Memo] Flavors of Graph: Directed?, Weighted?, Simple?, Sparse?
...
- ### Design patterns
    ...
    - [ ] [Series of videos (27 videos)](https://www.youtube.com/playlist?list=PLF206E906175C7E07)
       - [Tutorial 1,2] Abstract Class / Interface
       - [List] Strategy, Observer, Factory, Abstract Factory, 
...
- ### Networking
    ...
    - [Hard to listen to] [SSL and HTTPS (video)](https://www.youtube.com/watch?v=S2iBR2ZlZf0)
    - [I added] HTTP and SSL/TLS https://qiita.com/t_nakayama0714/items/83ac0b12ced9e7083927
